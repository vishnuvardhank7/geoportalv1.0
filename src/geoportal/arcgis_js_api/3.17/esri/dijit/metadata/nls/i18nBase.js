...
//>>built
define("esri/dijit/metadata/nls/i18nBase", {
	root: {
		general: {
			cancel: "Cancel",
			close: "Close",
		...
		metadataClassificationTopic: {
			caption: "Source",
			personalIdentifiableInformation: "Personal Identifiable Information",
			military: "Military",
			itar: "Intl. Traffic in Arms Regs (ITAR)",
			ear: "Export Administration Regs (EAR)",
			customerinfo: "Sensitive Customer Info",
			proprietary: "Boeing Proprietary"
		},
		metadataPurposeclassificationTopic: {
			caption: "Purpose",
			flight: "Autonomous Flight",
			fpd: "Flight planning & Dispatch",
			base: "Base map & Reference",
			data: "Internal data & Knowledge sharing",
			sales: "Marketing & Sales analysis",
			program: "Program execution",
			nav: "Navigation - Flight Management System"
		},
		multiplicity: {
