...
define(
		...
		function(a, b, c, d, g, h, k, e, f) {
			...
			c("extend-esri")
					&& b
							.setObject(
									"dijit.metadata.types.iso.gmd.identification.ResourceClassification",
									a, f);
			return a
		});