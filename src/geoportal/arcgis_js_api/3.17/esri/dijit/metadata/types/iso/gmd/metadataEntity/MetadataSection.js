...
define(
		...
		function(a, b, c, d, g, h, k, l, m, n, e, f) {
			...
			c("extend-esri")
					&& b
							.setObject(
									"dijit.metadata.types.iso.gmd.metadataEntity.MetadataSection",
									a, f);
			return a
		});