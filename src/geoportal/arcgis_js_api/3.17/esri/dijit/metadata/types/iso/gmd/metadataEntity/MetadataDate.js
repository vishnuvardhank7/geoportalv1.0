...
define(
		...
		function(a, b, c, d, g, h, k, e, f) {
			...
			c("extend-esri")
					&& b
							.setObject(
									"dijit.metadata.types.iso.gmd.metadataEntity.MetadataDate",
									a, f);
			return a
		});